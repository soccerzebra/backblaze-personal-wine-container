...
- Report a clear error when the Backblaze installer download fails, instead of saving the HTTP error page as `install_backblaze.exe` and running it under Wine
